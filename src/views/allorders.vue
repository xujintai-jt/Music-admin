  ...
  <div class="allorders">
    ...
    <div style="width:100%;background-color:#f40;">
      <el-table :data="allorders" class="order-table" style="width: 100%" border>
        ...
        <el-table-column prop="order_id" label="订单编号" align="center" width="250"></el-table-column>
        <el-table-column label="账号" prop="account" align="center" width="200"></el-table-column>
        <el-table-column prop="publicpwd" label="明文密码" align="center" width="150"></el-table-column>
        <el-table-column prop="money" align="center" width="100" label="金额"></el-table-column>
        <el-table-column align="center" prop="startTime" width="200" label="开始时间"></el-table-column>
        <el-table-column align="center" prop="endTime" width="200" label="结束时间"></el-table-column>
        <el-table-column align="center" prop="password" width="300" label="密文"></el-table-column>
...
export default {
  ...
  methods: {
          ...
          this.$axios
            ...
            .then((res) => {
              if (res.data == true) {
                this.$axios
                  .post(
                    "http://localhost:8633/api/admin/orders/del",
                    this.delRow
                  )
                  .then((res) => {
                    this.$nextTick(() => {
    ...
    getAllOrders() {
      this.selectDate = "";
      this.$axios
        .get("http://localhost:8633/api/admin/orders/all")
        .then((res) => {
