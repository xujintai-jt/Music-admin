  ...
  <div class="adminlikes">
    <Row style="padding:20px 60px 20px 40px;">
      ...
      <Col :span="4" style="text-align:right;">
        <el-button type="primary" @click="getAdminLikes">查看所有音乐</el-button>
      </Col>
    </Row>
    <!-- 歌曲数据表 -->
    <div style="width:100%;background-color:#f40;">
      <el-table :data="adminLikes" class="song-table" style="width: 100%" border>
        ...
        <el-table-column prop="src" align="center" width="200" label="音乐文件"></el-table-column>
        ...
        <el-table-column align="center" prop="style" width="120" label="风格"></el-table-column>
    ...
    <Modal draggable v-model="isCheckPassword" :mask-closable="false" width="360">
      ...
      <div style="text-align:left;font-size:14px;">
        <Row>
          ...
          <Col span="6">
            <el-button type="primary" size="large" @click="checkPwd()">验证</el-button>
          </Col>
        </Row>
      </div>
      <div slot="footer"></div>
...
export default {
  ...
  methods: {
          ...
          this.$axios
            ...
            .then((res) => {
              if (res.data == true) {
                this.$axios
                  .post(
                    "http://localhost:8633/api/admin/adminlike/del",
                    this.delRow
                  )
                  .then((res) => {
                    this.$nextTick(() => {
    ...
    onDeleteSong(song) {
      console.log(song);
      this.$confirm(
        `你确定要移除 ${song.songName} (${song.artist})音乐收藏吗?`,
        "提示",
        {
